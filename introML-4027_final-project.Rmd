...
tgrid <- expand.grid(
  mtry = c(4, sqrt(ncol(project_data)), 5, 6),      # Only choose 4,5,6 and sqrt(# predictors) for random subset of vars
...
Looks like we should be using at least 6 randomly selected variables for each predictor.
