...
The "No Information Rate", or, the accuracy of random guesses based on the distribution, is 0.6597.  In order to be better than random guessing, the different prediction accuracies must be greater than this value.  At first glance, this is definitely the case, the overall accuracy rate is 0.8295!  
...
While our overall accuracy rate is 82.95%, our accuracy rate for the classification of signal events (Neg Pred Value, above) is 77.63%.  This is definitely higher than the no information rate of 0.6597.  However, it's rather low, only performing 11.66% better than the No Information Rate.  

The accuracy rate for determining if something is a background event is 85.31%.  This is definitely high relative to the No Information Rate. 
